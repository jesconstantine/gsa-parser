...
<!-- *** search info bars *** -->
<xsl:variable name="show_search_info">0</xsl:variable>
...
<select name="site">
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='CBA')]">
   <option value="CBA" selected="selected">CBA</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='OGC_RULES')]">
   <option value="OGC_RULES" selected="selected">OGC_RULES</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="OGC_RULES">OGC_RULES</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='PhoneCampusMain')]">
   <option value="PhoneCampusMain" selected="selected">PhoneCampusMain</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="PhoneCampusMain">PhoneCampusMain</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='bliss')]">
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='dbCrawTestULResearchTools')]">
   <option value="dbCrawTestULResearchTools" selected="selected">dbCrawTestULResearchTools</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="dbCrawTestULResearchTools">dbCrawTestULResearchTools</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='dotCMS01')]">
   <option value="dotCMS01" selected="selected">dotCMS01</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="dotCMS01">dotCMS01</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='dotCMS02')]">
   <option value="dotCMS02" selected="selected">dotCMS02</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="dotCMS02">dotCMS02</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='edigest')]">
   <option value="edigest" selected="selected">edigest</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="edigest">edigest</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='gsa-test')]">
   <option value="gsa-test" selected="selected">gsa-test</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="gsa-test">gsa-test</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='id_ib')]">
   <option value="id_ib" selected="selected">id_ib</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="id_ib">id_ib</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='ifc')]">
   <option value="ifc" selected="selected">ifc</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='ir')]">
   <option value="ir" selected="selected">ir</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='libraries')]">
   <option value="libraries" selected="selected">libraries</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='ncate')]">
   <option value="ncate" selected="selected">ncate</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="ncate">ncate</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='ssp')]">
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='wayne')]">
   <option value="wayne" selected="selected">wayne</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='zipmail_search')]">
   <option value="zipmail_search" selected="selected">zipmail_search</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="zipmail_search">zipmail_search</option>
  </xsl:otherwise>
 </xsl:choose>
</select>
    </td>
...
<xsl:template name="spelling">
  <xsl:if test="/GSP/Spelling/Suggestion">
    <p><span class="p"><font color="{$spelling_text_color}">
       ...
       <a ctype="spell" href="?query={/GSP/Spelling/Suggestion[1]/@qe}&amp;spell=1&amp;filter=0&amp;getfields=*&amp;{$base_url}">
       <xsl:value-of disable-output-escaping="yes"
...
<xsl:template name="synonyms">
  <xsl:if test="/GSP/Synonyms/OneSynonym">
    ...
    <xsl:for-each select="/GSP/Synonyms/OneSynonym">
      <a ctype="synonym" href="?query={@q}&amp;{$synonym_url}">
...
<xsl:template match="R">
  ...
  <!-- *** Result Header *** -->
<xsl:text disable-output-escaping="yes">&lt;div class=&quot;result</xsl:text>
  
  <xsl:apply-templates select="MT[@N='subject']"></xsl:apply-templates>
  ...
  <xsl:if test="$show_res_title != '0'">
   <!-- TREVEDIT --><xsl:apply-templates select="MT[@N='librarianRecommended']" /><!-- END TREVEDIT -->
       <!-- TREVEDIT [TITLE SPAN]-->
    <span class="title">
    <!-- END TREVEDIT -->
...
<!-- TREVEDIT -->
                  ...
                  <div class="meta">                
	                  <ul class="toolTypes">
	                    <xsl:apply-templates select="MT[@N='research']" />
	                  </ul>

	                    
	                  <ul class="tags">
	                    <xsl:apply-templates select="MT[@N='tag']" />
	                  </ul>
                  </div>                   
                  </xsl:if>
...
<xsl:template match="MT[@N='research']">
	<li class="rTool">
		<xsl:value-of select="@V" />	
	</li>	 
</xsl:template>

<xsl:template match="MT[@N='subject']">
		<xsl:value-of select="@V" /> 
</xsl:template>

<xsl:template match="MT[@N='librarianRecommended']">
	<span class="libRec">
		Librarian Recommended
	</span>	
</xsl:template>

<xsl:template match="MT[@N='tag']">
	<li class="tag">
		<xsl:value-of select="@V" />
	</li> 	
</xsl:template>
...
<!-- <xsl:template match="MT">
		<xsl:if test="@N = 'research'">
				<Tool><xsl:value-of select="@V" /></Tool> 
		</xsl:if>

		<xsl:if test="@N = 'subject'">
				<Subject><xsl:value-of select="@V" /></Subject> 
		</xsl:if>

		<xsl:if test="@N = 'tag'">
				<Tag><xsl:value-of select="@V" /></Tag> 
		</xsl:if>

		<xsl:if test="@N = 'librarianRecommended'">
				<LR>1</LR>
		</xsl:if>
	<xsl:value-of select="@N"/></span><xsl:value-of select="@V"/>
</xsl:template> -->
